...
const AnnouncementsTopbar = () => {
  return (
    <div className="w-full h-[70px] bg-neutral-100 dark:bg-neutral-950 flex items-center justify-between border-b border-[1.5px] border-neutral-200 dark:border-neutral-700">
      <div className="flex">
        ...
        <div className="flex gap-[10px] ml-[14px]">
          <Image
            src={"/announcements-topbar/ai-powered.svg"}
            width={15}
            height={17}
            alt="AI-Powered"
          />
      ...
      <div className="flex gap-[10px] mr-[60px]">
        <Image
          src={"/announcements-topbar/updates.svg"}
          width={14}
          height={10}
          alt="AI-Powered"
        />
